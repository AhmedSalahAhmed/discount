            ...
            <div class="sidebar-nav collapse navbar-collapse show " id="side-menu-wrapper">
                <ul class="nav navbar-nav navbar-collapse flex-column side-nav list-group" id="side-menu">
                    ...
                    <li class="list-group-item">
                        <a href="{{ route('home') }}"><i class="fa fa-dashboard fa-fw"></i> لوحةالتحكم</a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('department.index') }}"><i class="fa fa-table fa-fw"></i> الاقسام</a>
                    </li>
                    <li class="list-group-item">
                        <a href="{{ route('store-crud.index') }}"><i class="fa fa-edit fa-fw"></i> المتاجر</a>
                    </li>
                    <li class="list-group-item">
                        <a href="#"><i class="fa fa-edit fa-fw"></i> الفروع</a>
                    </li>
                    <li class="list-group-item">
                        <a href="#"><i class="fa fa-edit fa-fw"></i> العروض</a>
                    </li>
                    ...
                    <div class="card card-primary card-inverse">
                        ...
                        <div class="card-footer card-default">
                            <a href="{{ route('department.index') }}">
                                <span class="float-sm-left">عرض&nbsp;التفاصيل</span>
